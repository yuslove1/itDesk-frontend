...
export async function logout() {
  ...
  // The socket's own auth check only runs once, at connection time — logging
  // out doesn't automatically drop an already-open connection, so it has to
  // be closed explicitly here.
  disconnectSocket();
}
